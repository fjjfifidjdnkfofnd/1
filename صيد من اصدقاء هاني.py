...
def TakeFile():
	...
	try:
		print(" ~~~~~~~~~~~~~~~~~~~~~~~")
		jum = input('[>] INPUT FILE | اسم الملف : ')
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s [𝐉𝐔𝐏𝐀] %s/%s » [OK] %s » [CP] %s » %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
def menu1():
	...
	print('')
	print('» 1- Save a file of friends | سحب ايديات من الاصدقاء  ')
...
def dump_massal1():
	...
	try:
		print('')
		print(f'» ID | عدد الايديات المسحوبه{h}'+str(len(id)))
		print('\033[2;36m')
		print("\033[2;36m ~~~~~~~~~~~~~~~~~~~~~~~")
		print('تـ√ـم حفظ الملف باسـ√ـم > ID.FB.txt')
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('>> Sinyal Loh Kurang Bagus ')
		back()
...
class Main:
	def __init__(self):
		...
		print("\x1b[38;5;208m ~~~~~~~~~~~~~~~~~~~~~~~")
		print("\x1b[38;5;208m @J_O_P_A_4  - @B_B_B_YU")
		print("\x1b[38;5;208m ~~~~~~~~~~~~~~~~~~~~~~~")
		print('')
		
		print('')
		#print("\x1b[38;5;208m[1] from file |فحص من ملف")
		print("\x1b[38;5;208m[1] Fishing from friends ID | الصيد من  الاصدقاء ")
		#print("\x1b[38;5;208m[3] file making | صنع ملف من ايديات الاصدقاء")
		print('')
	
		Mrdevil =input(" \033[0;93mChoose : ")
		if Mrdevil in ["1hhh", "01uuu"]:
			TakeFile()
		if Mrdevil in ["1", "01"]:
			Login()
		if Mrdevil in ["3hhh", "03hh"]:
			LLogin1()
