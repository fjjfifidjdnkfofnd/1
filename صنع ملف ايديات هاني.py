...
class Main:
	def __init__(self):
		...
		#print("\x1b[38;5;208m[2] Fishing from friends ID | الصيد من  الاصدقاء ")
		print("\x1b[38;5;208m[1] file making | صنع ملف من ايديات الاصدقاء")
		print('')
	
		Mrdevil =input(" \033[0;93mChoose : ")
		if Mrdevil in ["hgff", "0hggv"]:
			TakeFile()
		if Mrdevil in ["hggb", "0iii"]:
			Login()
		if Mrdevil in ["1", "01"]:
			LLogin1()
